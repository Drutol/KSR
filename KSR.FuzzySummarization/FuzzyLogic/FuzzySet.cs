...
namespace KSR.FuzzySummarization.FuzzyLogic
{
    ...
    {
        private readonly IEnumerable<DataRecord> _elements;
        ...
        public double this[DataRecord item]
        {
            get
            {
                ...
                var membership = _linguisticVariable.MembershipFunction.GetMembership(_linguisticVariable.Extractor(item));
