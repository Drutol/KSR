...
namespace KSR.FuzzySummarization.DataProcessing
{
    ...
    {
        private readonly List<string> _educations = new List<string>
        {
            "Bachelors",
            "Some-college",
            "11th",
        ...
        private readonly List<string> _maritalStatuses = new List<string>
        {
            "Married-civ-spouse",
            "Divorced",
            "Never-married",
        ...
        private readonly List<string> _nativeCountries = new List<string>
        {
            "United-States",
            "Cambodia",
            "England",
        ...
        private readonly List<string> _occupations = new List<string>
        {
            "Tech-support",
            "Craft-repair",
            "Other-service",
        ...
        private readonly List<string> _races =
            new List<string> {"White", "Asian-Pac-Islander", "Amer-Indian-Eskimo", "Other", "Black"};
        ...
        private readonly List<string> _workClasses = new List<string>
        {
            "Private",
            "Self-emp-not-inc",
            "Self-emp-inc",
        ...
        public IEnumerable<DataRecord> ObtainRecords()
        {
            ...
            {
                var tokens = line.Split(new[] {','}, StringSplitOptions.RemoveEmptyEntries).Select(s => s.Trim())
                    .ToList();
                if (!tokens.Any())
                    continue;
